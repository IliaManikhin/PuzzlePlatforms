...
FVector UGrabber::GetReachLineStart()
{
	...
	PlayerViewPointLocation = GetWorld()->GetFirstPlayerController()->GetPawn()->GetActorLocation();
	PlayerViewPointRotation = GetWorld()->GetFirstPlayerController()->GetPawn()->GetActorRotation();
